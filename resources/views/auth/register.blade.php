    ...
    <div class="w-full max-w-md relative z-10">
        ...
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
            ...
            <div class="bg-gradient-to-r from-purple-600 to-pink-600 p-8 text-white text-center">
                ...
                <p class="text-purple-100">Rejoignez-nous dès aujourd'hui</p>
            </div>
            ...
            <div class="p-8">
                <form method="POST" action="{{ route('registersubmit') }}">
                    ...
                    <div class="mb-6">
                        <label class="flex items-start">
                            ...
                            <span class="ml-2 text-sm text-gray-600">
                                J'accepte les 
                                <a href="#" class="text-purple-600 hover:text-purple-800 font-medium">conditions d'utilisation</a> 
                                et la 
                                <a href="#" class="text-purple-600 hover:text-purple-800 font-medium">politique de confidentialité</a>
                            </span>
                        </label>
                    </div>
                    ...
                    <button 
                        type="submit"
                        class="w-full bg-gradient-to-r from-purple-600 to-pink-600 text-white font-semibold py-3 px-4 rounded-lg hover:from-purple-700 hover:to-pink-700 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 transform transition duration-200 hover:scale-[1.02] active:scale-[0.98]"
                    >
                        S'inscrire
                    </button>
                </form>
